...
namespace PlanePal.Services.Implementation
{
    public class BookingService : IBookingService
    {
        ...
        public async Task<ServiceResponse<string>> BookFlight(BookFlightDTO dto, string userEmail)
        {
            ...
            if (scheduledFlight.Departure.Scheduled < DateTime.Now)
            {
                return new ServiceResponse<string>(null, false, "Cannot book the flight because the departure date has already passed");
            }
        ...
        public async Task<ServiceResponse<string>> UpdateBookedFlight(UpdateBookedFlightDTO updateBookedFlightDTO, string email)
        {
            ...
            if (bookedFlight.IsCanceled)
            {
                return new ServiceResponse<string>(null, false, "The flight cannot be updated, because it is cancelled.");
            }
